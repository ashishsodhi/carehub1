...
import com.care.carehub.service.TaskService;
...
/**
 * REST controller for managing {@link com.care.carehub.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
    ...
    public List<Task> getAllTasks(@RequestParam(required = false) String filter) {
        if ("recipientitem-is-null".equals(filter)) {
            log.debug("REST request to get all Tasks where recipientItem is null");
            return taskService.findAllWhereRecipientItemIsNull();
        }
