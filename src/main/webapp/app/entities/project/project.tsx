              ...
              <tbody>
                {projectList.map((project, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{project.createdByMemberId}</td>
                    <td>{project.serviceId}</td>
                    <td>{project.status}</td>
                    <td>
                      <TextFormat type="date" value={project.statusTLM} format={APP_DATE_FORMAT} />
                    </td>
                    <td>
                      <TextFormat type="date" value={project.whenCreated} format={APP_DATE_FORMAT} />
                    </td>
